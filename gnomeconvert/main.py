...
class GconvertApplication(Adw.Application):
    ...
    def __init__(self,VERSION):
        super().__init__(application_id='com.qsk.gconvert',
    ...
    def do_activate(self):
        ...
        if not win:
            win = GconvertWindow(application=self)
    ...
    def on_about_action(self, widget, _):
        ...
        about = Adw.AboutWindow(transient_for=self.props.active_window,
                                ...
                                application_icon='com.qsk.gconvert',
                                developer_name='quentin',
    ...
    def on_file_selected(self, widget):
        ...
        print("Document sélectionné : ", filename)
...
def main(version):
    ...
    app = GconvertApplication(version)
